...
const Dashboard = ({ onLogout }) => {
  ...
  const fetchStatistics = async () => {
    try {
      const responseUsers = await fetch('https://adminzaindev.zaindev.com.sa/statistics/users');
      const dataUsers = await responseUsers.json();
      setNumberOfUsers(dataUsers.numberOfUsers);

      const responseTechnicians = await fetch('https://adminzaindev.zaindev.com.sa/statistics/technicians');
      const dataTechnicians = await responseTechnicians.json();
      setNumberOfTechnicians(dataTechnicians.numberOfTechnicians);

      const responsePendingReservations = await fetch('https://adminzaindev.zaindev.com.sa/statistics/pending-reservations');
      ...
      const responseTotalReservations = await fetch('https://adminzaindev.zaindev.com.sa/statistics/reservations');
      ...
      const responseDoneReservations = await fetch('https://adminzaindev.zaindev.com.sa/statistics/done-reservations');
