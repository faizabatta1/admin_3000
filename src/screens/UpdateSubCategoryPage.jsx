...
const UpdateSubCategoryPage = () => {
    ...
    const fetchSubCategory = async () => {
        try {
            const response = await axios.get(`http://adminzaindev.zaindev.com.sa:3000//subCategories/self/${id}`);
    ...
    const handleUpdateSubCategory = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.put(`http://adminzaindev.zaindev.com.sa:3000//subCategories/${id}`, {
                name,
                nameAr,
