...
const Users = () => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get('http://adminzaindev.zaindev.com.sa:3000//users', {
        headers: {
  ...
  const deleteUser = async (id) => {
    try {
      await axios.delete(`http://adminzaindev.zaindev.com.sa:3000//users/${id}`);
  ...
  const handleDeleteAll = async () => {
    try {
      let response = await axios.delete('http://adminzaindev.zaindev.com.sa:3000//users');
      alert(response.data);
