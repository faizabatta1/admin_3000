...
const UpdatePopularTechnicianPage = () => {
    ...
    const fetchTechnician = async () => {
        try {
            setIsLoading(true);
            const response = await axios.get(`http://adminzaindev.zaindev.com.sa:3000//popularTechnicians/${id}`);
    ...
    const handleUpdateTechnician = async () => {
        try {
            ...
            let response = await axios.put(`http://adminzaindev.zaindev.com.sa:3000//popularTechnicians/${id}`, formData);
