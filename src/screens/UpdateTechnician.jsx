...
const UpdateTechnician = ({ onLogout }) => {
  ...
  const fetchTechnician = async () => {
    try {
      setIsLoading(true);
      const response = await axios.get(`http://adminzaindev.zaindev.com.sa:3000//technicians/${id}`);
  ...
  const fetchSubCategories = async (categoryId) => {
    try {
      const response = await axios.get(`http://adminzaindev.zaindev.com.sa:3000//subCategories/${categoryId}`);
  ...
  const handleUpdateTechnician = async (e) => {
    ...
    try {
      ...
      let response = await axios.put(`http://adminzaindev.zaindev.com.sa:3000//technicians/${id}`, formData, {
        headers: {
