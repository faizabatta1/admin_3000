...
const UpdateTechnician = ({ onLogout }) => {
  ...
  const fetchTechnician = async () => {
    try {
      setIsLoading(true);
      const response = await axios.get(`https://adminzaindev.zaindev.com.sa/technicians/${id}`);
  ...
  const handleUpdateTechnician = async (e) => {
    ...
    try {
      ...
      let response = await axios.put(`https://adminzaindev.zaindev.com.sa/technicians/${id}`, formData, {
        headers: {
